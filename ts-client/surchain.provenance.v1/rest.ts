...
import { QueryParamsResponse } from "./types/surchain/provenance/v1/query";

import { QueryParamsRequest } from "./types/surchain/provenance/v1/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/surprotocol/surchain/provenance/v1/params
   */
  queryParams = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryParamsResponse>>>({
      path: `/surprotocol/surchain/provenance/v1/params`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
