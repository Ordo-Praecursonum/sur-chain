...
import { IgntModule as SurchainAttestationV_1, msgTypes as SurchainAttestationV_1MsgTypes } from './surchain.attestation.v1'
import { IgntModule as SurchainIdentityV_1, msgTypes as SurchainIdentityV_1MsgTypes } from './surchain.identity.v1'
import { IgntModule as SurchainProvenanceV_1, msgTypes as SurchainProvenanceV_1MsgTypes } from './surchain.provenance.v1'
import { IgntModule as SurchainSurchainV_1, msgTypes as SurchainSurchainV_1MsgTypes } from './surchain.surchain.v1'
...
const Client = IgniteClient.plugin([
    SurchainAttestationV_1, SurchainIdentityV_1, SurchainProvenanceV_1, SurchainSurchainV_1, CosmosNftV_1Beta_1, CosmosUpgradeV_1Beta_1, IbcApplicationsInterchainAccountsControllerV_1, IbcApplicationsInterchainAccountsHostV_1, IbcApplicationsTransferV_1, IbcCoreChannelV_1, IbcCoreChannelV_2, IbcCoreClientV_1, IbcCoreClientV_2, IbcCoreConnectionV_1, CosmosEvidenceV_1Beta_1, CosmosFeegrantV_1Beta_1, CosmosCircuitV_1, CosmosAuthV_1Beta_1, CosmosAuthzV_1Beta_1, CosmosBankV_1Beta_1, CosmosBaseNodeV_1Beta_1, CosmosBaseTendermintV_1Beta_1, CosmosConsensusV_1, CosmosDistributionV_1Beta_1, CosmosEpochsV_1Beta_1, CosmosGovV_1, CosmosGovV_1Beta_1, CosmosGroupV_1, CosmosMintV_1Beta_1, CosmosParamsV_1Beta_1, CosmosSlashingV_1Beta_1, CosmosStakingV_1Beta_1, CosmosTxV_1Beta_1, CosmosVestingV_1Beta_1
]);

const registry = new Registry([
  ...SurchainAttestationV_1MsgTypes,
  ...SurchainIdentityV_1MsgTypes,
  ...SurchainProvenanceV_1MsgTypes,
  ...SurchainSurchainV_1MsgTypes,
